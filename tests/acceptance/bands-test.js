...
andThen(function() {
  ...
  assertElement(assert, '.nav a.active:contains("Songs")', 1, 'The Songs tab is active');
  });
});
...
andThen(function() {
  assertElement(assert, '.songs .song:contains("Killer Car")', 1, "Creates the song and displays it in the list");
  });
});